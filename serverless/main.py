...
# This request needs to call a new lambda function to update the database.
# @app.route("/update_db")
# def update_db():
...
# This request needs to be shifted to access an S3 Bucket
...
# This request should also access S3
